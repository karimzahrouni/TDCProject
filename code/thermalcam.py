...
import random
import math
from utils import sendemail , face_detect #, Objectclass
...
for frame in camera.capture_continuous(rawCapture, format="rgb", use_video_port=True):
	...
	#if Objectclass(frame):  ## if detect any persone
	...
	if temp > temperaturLimet : 
		sendemail(frame)  ## take photo and send it by email adresse
		continue
	else :
		pass
